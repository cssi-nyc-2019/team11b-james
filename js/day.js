...
let objectiveForm = document.querySelector('.section form');
objectiveForm.addEventListener('submit',objectiveFormOnSubmit);

function objectiveFormOnSubmit{
	let id;
	$.post('/objectives',{'current_date':id});
}
